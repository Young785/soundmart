$(document).ready(function(){
    $(".post-form").submit(function(event){
        ...
        var post_name = $(".image_name_a").val();
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $(".wlc-div").addClass("keep");
                $(".result-image").addClass("keep");
                ...
                modal_content +=    '<div class="more">';
                    ...
                    modal_content +=    '<div class="chat-list">';
                        modal_content +=    '<ul id="chat_history_'+to_user_id+'" class="show-chats"></ul>';
                            ...
                            modal_content +='<div class="" style="height: 48px;">';
...
$(document).ready(function(){
    ...
    $(document).on('click', '.send_chat', function(event){
        ...
        if (chat_message == "") {
            ...
            // document.get(chat_message).innerHTML == ""; 
            // $(chat_message).val('');
            $.ajax({
                url:"/insert_chat",
                method:"POST",
