                    ...
                    <div class="col-md-6">
                        <div class="banner">
                            ...
                            <ul>
                                ...
                                <li>You Search for: {{ $search_term}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <a href="/invest/{{ $project->name_slug }}">
                                <div class="services-item-2">
                                    <div class="services-item-img-box">
                                        <img class="img-fluid trending-img" src="assets/images/documents/{{ $project->content_artwork }}" alt="03 services">
                                    </div>
